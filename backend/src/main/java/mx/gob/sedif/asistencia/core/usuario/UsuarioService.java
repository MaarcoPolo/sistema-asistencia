...
public class UsuarioService {
    ...
    public UsuarioRecord create(UsuarioRecord record) {
        ...
        // Cambiado de findByMatricula a findByNumeroControl
    ...
    private UsuarioRecord toRecord(Usuario entity) {
        ...
        return new UsuarioRecord(
                entity.getId(),
                entity.getNumeroControl(), // Cambiado de matricula a numeroControl
                entity.getNombre(),
    ...
    private void mapToEntity(UsuarioRecord record, Usuario entity) {
        ...
        entity.setNumeroControl(record.numeroControl()); // Cambiado de matricula a numeroControl
